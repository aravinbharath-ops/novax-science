...
verifyForm.addEventListener('submit', async event => {
  ...
  try {
    ...
    verifyResult.innerHTML = `<strong>Authentic Novax Science Product</strong><br>${data.certificate.product} · ${data.certificate.strength} · ${data.certificate.analysisDate}<br><button type="button" class="inline-certificate-button" data-open-current-certificate>View certificate</button>`;
  } catch (error) {
    verifyResult.className = 'verify-result';
